{pkgs, ...}: {
  ...
  programs.zsh = {
    ...
    shellAliases = {
      ...
      lwdc = "docker-compose -f docker-compose.yml -f extra/account.yml -f extra/adminer.yml -f extra/website.yml -f extra/marketplace.yml -f docker-compose.override.yml";
